...
func TestHTTPAuthenticationAndAuthorizationLinter(t *testing.T) {
	...
	publicRoutePatterns := []*regexp.Regexp{
		...
		regexp.MustCompile(`^GET /pvp/rooms$`),
		regexp.MustCompile(`^GET /pvp/rooms/\{room_id\}$`),
		regexp.MustCompile(`^GET /gvg/rooms$`),
		regexp.MustCompile(`^GET /gvg/rooms/\{room_id\}$`),
		regexp.MustCompile(`^GET /gvg/standings/\{guild_id\}$`),
		regexp.MustCompile(`^GET /gvg/leaderboard$`),
		regexp.MustCompile(`^GET /replays/\{id\}$`),
		regexp.MustCompile(`^GET /replays/recent$`),
		regexp.MustCompile(`^GET /gemstore/catalog$`),
		regexp.MustCompile(`^GET /gemstore/recipes$`),
		regexp.MustCompile(`^GET /gemstore/dialogue$`),
		regexp.MustCompile(`^GET /blacksmith/seals$`),
		...
		regexp.MustCompile(`^GET /parties$`),
		regexp.MustCompile(`^GET /parties/\{id\}$`),
		regexp.MustCompile(`^GET /guilds$`),
		...
		regexp.MustCompile(`^GET /casino/prizes$`),
		regexp.MustCompile(`^GET /casino/rooms$`),
		regexp.MustCompile(`^GET /casino/rooms/\{roomId\}$`),
	}
