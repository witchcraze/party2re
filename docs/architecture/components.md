...
| **Collection** | `internal/collection` | Illustrated monster defeat and item discovery encyclopedia, 100% completion milestones, Hall of Fame induction hooks | Character, Notification | MariaDB `character_monster_book`, `character_item_collection`, `character_collection_completions` |
