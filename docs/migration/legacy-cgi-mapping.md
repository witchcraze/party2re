...
| `lib/sleep.cgi` | 睡眠 (無料全快・日次リセット) | `internal/home/` | `internal/api/http/home.go` | `docs/design/resting.md`<br/>`docs/api/paths/home.json` | Reconciling (#459) | 🚨 有料の「宿屋 (`internal/inn`)」は架空。自宅・他人の家で寝て無料回復＆日次リセット |
