...
- [x] Helper and player rescue assistance (#79, #213, #659, #680, #792)
...
- [x] Collection and Monster Book encyclopedia with combat defeat recording, canonical thresholds (180 monsters, 141 items, 71 weapons, 55 armors), 100% completion news, and comp_wea/comp_arm Hall of Fame induction (#85, #797, #832, #840)
