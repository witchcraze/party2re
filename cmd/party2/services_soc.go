...
func (s *socServices) registerWorkerHandlers(activityService *activity.Service, chapelService *chapel.Service, lotteryService *lottery.Service, contestService *contest.Service) {
	if s.worker != nil {
