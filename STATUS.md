...
Last updated: Issue #173 — Standardize Battle Replay recording helper across combat modes
...
- **Database**: MariaDB（マイグレーション `migrations/001_initial.sql` 〜 `031_rescue_and_helper.sql`、`make db-migrate` / `make db-reset`）。
