...
- **Durable Persistence**: MariaDB Master (Migrations `001`–`087`) with deterministic row-lock hierarchy (Rank 0→8) and ambient transaction propagation (`database.RunInTx`).
