...
- **Database**: MariaDB（マイグレーション `migrations/001_initial.sql` 〜 `054_casino_poker_sessions.sql`、`make db-migrate` / `make db-reset`、プレイヤー資産・キャラクター・所持品・経済の永続権威 MariaDB Master、揮発性 `player_sessions`, `parties`, `party_members` テーブルの完全廃止）。
